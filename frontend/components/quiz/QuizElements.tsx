...
const StayMotivatedStatic = ({ screenWidth }: QuizStepProps) => {
  return (
    <View
      style={{ width: screenWidth * 0.9 }}
      className="flex items-center justify-center p-5">
      <Text className="text-2xl font-bold text-center mb-2">Stay motivated</Text>
      <Text className="text-sm text-center">
        <Text className="text-base font-semibold">🌟 Set goals</Text>
        {'\n'}
        Set goals to earn stars and complete quizzes. Challenge yourself to
        learn more about ecology and earn more stars.
        {'\n'}
        {'\n'}
        <Text className="text-base font-semibold">📤 Share your progress</Text>
        {'\n'}
